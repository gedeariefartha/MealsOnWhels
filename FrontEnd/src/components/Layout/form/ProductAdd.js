...
const ProductAdd = () => {
  ...
  const onSubmitHandler = (e) => {
    ...
    const inputStaff = inputStaffRef.current.value;

    axios
      .post(
        "http://localhost:8082/api/meal/post-product",
        {
          name: inputName,
          desc: inputDesc,
          status: inputstatus,
  ...
  <Layout>  
    <div className="d-flex justify-content-center my-5">
      <div className="form-auth">
        <h3 className="mb-3 fw-semibold text-center">Post Product</h3>
